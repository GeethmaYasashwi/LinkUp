...
var MyApp = (function(){
    ...
    function event_process_for_signaling_server(){
        ...
        if(other_users)
            for(var i=0;i<other_users.length;i++){
                ...
                AppProcess.setNewConnection(other_users[i].connectionId); // let know about other users in the page
            }
    ...
    $(document).on("click",".end-call-wrap",function(){
        $(".top-box-show").css({
            "display":"block"
        }).html('<div class="top-box align-vertical-middle profile-dialogue-show"> <h4 class="mt-3 style="text-align:center;color:white;">Leave Meeting</h4><hr> <div class="call-leave-cancel-action d-flex justify-content-center align-items-center 2-100"> <a href="/action.html"><button class="call-leave-action btn btn-danger mr-5">Leave</button></a> <button class="call-cancel-action btn btn-secondary">Cancel</button> </div> </div> ')
